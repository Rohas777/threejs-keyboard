...
export function Loader() {
    ...
    return (
        ...
        >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-auto" fill="none" viewBox="0 0 1385 326">
                <path
                    fill="#fff"
            ...
            >
                <g id="loading-screen">
                    <g id="base">
                        <rect id="front" width="6278" height="782.9" x="0.1" y="503" fill="#9B9B9B" rx="222"></rect>
                        <rect id="top" width="6278" height="1075.6" x="0.1" y="0.1" fill="#D9D9D9" rx="222"></rect>
                        <path
                            id="highlight"
                            fill="#EFEFEF"
                        ...
                        ></path>
                        <rect id="well" width="6012.6" height="868.8" x="132.8" y="89" fill="#1F1F1F" rx="147"></rect>
                    </g>
                    <mask
                        id="mask0_753_226"
                        width="6014"
                    ...
                    >
                        <rect id="mask" width="6012.6" height="868.8" x="132.8" y="89" fill="#1F1F1F" rx="147"></rect>
                    </mask>
